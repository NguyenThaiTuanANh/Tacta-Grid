...
public class ResultUI : MonoBehaviour
{
    ...
    [SerializeField] private GameObject contentsWinTurn;
    ...
    [SerializeField] private Button nextButtonWinTurn;
    [SerializeField] private Button mainMenuButtonWinTurn;
    ...
    private void Awake()
    {
        ...
        if (nextButtonWinTurn != null)
        {
            nextButtonWinTurn.onClick.AddListener(OnNextClicked);
        }
        if (mainMenuButtonWinTurn != null)
        {
            mainMenuButtonWinTurn.onClick.AddListener(OnMainMenuClicked);
        }
    }
    ...
    public void HideAll()
    {
        ...
        if (contentsWinTurn != null)
            contentsWinTurn.SetActive(false);
    }
